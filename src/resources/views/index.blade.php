            ...
            <form action="/search" method="get" class="search__form">
                ...
                <div class="sort__select">
                    <label class="select-box__label sort__label">
                        <select name="sort" class="select-box__item sort__item">
                            <option value="random" {{request('sort') == 'random' ? 'selected' : ''}}>ランダム</option>
                            <option value="high_rating" {{request('sort') == 'high_rating' ? 'selected' : ''}}>評価の高い順
                            </option>
                            <option value="low_rating" {{request('sort') == 'low_rating' ? 'selected' : ''}}>評価の低い順
                            </option>
                        </select>
                    </label>
                </div>
            ...
            <div class="shop__button">
                ...
                <form action="{{ route('favorite.delete',$shop) }}" method="post"
                    ...
                    <button type="submit" class="shop__button-favorite-btn" title="お気に入り削除">
                        <img class="favorite__btn-image favorite__btn-image--red"
