...
@section('content')
    ...
    @endif
    <form class="header__wrap" action="/shop/confirm/shop-reservation" method="get">
        @csrf
            ...
            <tbody>
                @if ($reservations !== null)
                    @forelse ($reservations as $reservation)
                        <tr>
                            <form action="/shop/update/shop-reservation" method="post">
                                @method('patch')
                                @csrf
                            ...
                            <form action="/shop/destroy/shop-reservation" method="post">
                                @method('delete')
                                @csrf
                                <td class="table__data table__data-button">
                                    <input type="hidden" name="id" value="{{ $reservation->id }}">
